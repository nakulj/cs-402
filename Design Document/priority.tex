...
\subsection{Synchronization}
	\subsubsection{}
		A potential race hazard arising from the use of the \code{thread_set_priority()} function is the scheduler selecting a thread to run based on the old value of the thread's \epr. 
